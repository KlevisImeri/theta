...
data class BackendConfig<T : SpecBackendConfig>(
  ...
  private var _softTimeoutMs: Long = 0
  @Parameter(names = ["--soft-timeout-ms"])
  var softTimeoutMs: Long
    get() = if (_softTimeoutMs == 0L) timeoutMs else _softTimeoutMs
    set(value) { _softTimeoutMs = value }
...
data class DebugConfig(
  ...
  var logTypes: Array<String> = arrayOf("result"),
  @Parameter(
    names = ["--arg-debug"],
